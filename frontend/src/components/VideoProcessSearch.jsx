...
import { Search, Users, Play, Sparkles, Loader2 } from 'lucide-react';
...
const VideoProcessSearch = ({ onVideoProcessed, stayOnPage = false }) => {
  ...
  return (
    <div className="relative max-w-2xl mx-auto" ref={searchRef}>
      ...
      {isOpen && results.length > 0 && !detectVideoURL(query) && !detectChannelURL(query) && (
      ...
      {query.length >= 2 && !detectVideoURL(query) && !detectChannelURL(query) && results.length === 0 && (
